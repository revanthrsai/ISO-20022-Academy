...
That outside is the **Business Application Header**, **head.001**, the BAH for short. It is a small, standard block that rides in front of every business message, carrying exactly the facts a network needs to move and check the message **without reading its contents**.
