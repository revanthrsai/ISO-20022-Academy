...
- **Recall**: *after* settlement, initiated by the **sending** bank, who realises *it* made a mistake and *asks* the receiver to give the money back. That's a request (camt.056), not a guaranteed return. It gets the next chapter.
